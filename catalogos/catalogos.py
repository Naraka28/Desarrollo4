...
def agrega_revistas_a_dict(dic:dict,titulos_revistas,area):
    for titulo in titulos_revistas:
...
def asigna_areas_a_revistas(d_revistas:dict, d_areas:dict):
    for titulo,revista in d_revistas.items():
        for r in revista:
            titulo_revista=r.titulo.upper()
            if titulo_revista in d_areas.keys():
                areas = d_areas[titulo_revista]
...
def main(folder:str, folder_areas:str, keys:list):
    ...
    for files in files_list:
        ...
        for titulo in titulos:
            ...
            #agregar revista al diccionario Objetos k:titulo v:Revista
            agregar_revista_diccionario(diccionario,revista)
    #Diccionario con titulo de la revista con sus areas k:tituvo v:area
